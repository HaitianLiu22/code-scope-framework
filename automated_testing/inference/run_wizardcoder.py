...
def parse_arguments():
    ...
    parser.add_argument('--checkpoint', default='WizardLM/WizardCoder-15B-V1.0',
                        choices=[
...
def main():
    ...
    save_data_path = Path(__file__).parent / Path('results') / Path('automated_testing_result_wizardcoder.jsonl')
...
if __name__ == '__main__':
    ...
    log_file_path = Path(__file__).parent.parent / Path('logs') / Path('automated_testing_log_wizardcoder.log')
