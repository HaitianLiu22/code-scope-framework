...
def main():
    ...
    save_data_path = Path(__file__).parent / Path('results') / Path('automated_testing_result_starcoder.jsonl')
...
if __name__ == '__main__':
    ...
    log_file_path = Path(__file__).parent.parent / Path('logs') / Path('automated_testing_log_starcoder.log')
