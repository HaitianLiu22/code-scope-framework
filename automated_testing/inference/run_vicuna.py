...
def parse_arguments():
    ...
    parser.add_argument('--checkpoint', default='lmsys/vicuna-13b-v1.5-16k',
                        choices=[
...
def main():
    ...
    save_data_path = Path(__file__).parent / Path('results') / Path('automated_testing_result_vicuna.jsonl')
...
if __name__ == '__main__':
    ...
    log_file_path = Path(__file__).parent.parent / Path('logs') / Path('automated_testing_log_vicuna.log')
