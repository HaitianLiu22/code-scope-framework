...
def main():
    ...
    save_data_path = Path(__file__).parent / Path('results') / Path('code_review_result_wizardcoder.jsonl')
...
if __name__ == '__main__':
    ...
    log_file_path = Path(__file__).parent.parent / Path('logs') / Path('code_review_log_wizardcoder.log')
